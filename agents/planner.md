...
tools: Read, Write, Edit, Bash, Grep, Glob, SendMessage, mcp__claude_ai_Linear__get_issue, mcp__claude_ai_Linear__list_comments, mcp__claude_ai_Linear__get_project, mcp__claude_ai_Linear__get_document, mcp__claude_ai_Linear__save_issue
---
